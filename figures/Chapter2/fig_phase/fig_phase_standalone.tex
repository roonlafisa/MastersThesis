...
\addplot [thick, color=red, solid] table [col sep=comma] {./fig_phase/uv_uncomp.csv};
\addplot [thick, color=blue, solid] table [col sep=comma] {./fig_phase/uv_comp.csv};
\addplot [thick, color=black, dashed] table [col sep=comma] {./fig_phase/uv_ideal.csv};
